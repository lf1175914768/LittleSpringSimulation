...
public class CustomCollectionEditor extends PropertyEditorSupport {
	...
	public CustomCollectionEditor(Class<?> collectionType, boolean nullAsEmptyCollection) {
		...
		if(!Collection.class.isAssignableFrom(collectionType)) {
			throw new IllegalArgumentException("Collection type [" + collectionType.getName() + "] does not implement "
	...
	public void setValue(Object value) {
		if(value == null && this.nullAsEmptyCollection) {
			...
			// Convert array elements to Collection
			...
			// A plain value : convert it to a collection with single element.
