...
public class ReaderContext {
	...
	public void error(String message, Object source, ParseState parseState, Throwable ex) {
		Location location = new Location(getResource(), source);
		this.problemReporter.error(new Problem(message, location, parseState, ex));
	}
