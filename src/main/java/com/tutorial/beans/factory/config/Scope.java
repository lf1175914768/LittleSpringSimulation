 ...
 *
 * <p>{@link com.tutorial.context.ApplicationContext} implementations
 * such as a {@link com.tutorial.web.context.WebApplicationContext}
 * may register additional standard scopes specific to their environment,
 * e.g. {@link com.tutorial.web.context.WebApplicationContext#SCOPE_REQUEST "request"}
 * and {@link com.tutorial.web.context.WebApplicationContext#SCOPE_SESSION "session"},
 ...
 * @see com.tutorial.aop.scope.ScopedProxyFactoryBean
 * @see com.tutorial.web.context.request.RequestScope
 * @see com.tutorial.web.context.request.SessionScope
 */
public interface Scope {
	
	/**
	 * Return the object with the given name from the underlying scope,
	 * {@link com.tutorial.beans.factory.ObjectFactory#getObject() creating it}
	 ...
	 * @see com.tutorial.beans.factory.support.AbstractBeanDefinition#getDestroyMethodName()
