...
import com.tutorial.core.env.AbstractEnvironment;
...
public abstract class AbstractBeanDefinitionReader implements EnvironmentCapable, BeanDefinitionReader {
	 ...
	 * {@link com.tutorial.context.ApplicationContext} implementations.
	 ...
	 * use a {@link AbstractEnvironment}. All ApplicationContext implementations are
	...
	public void setBeanNameGenerator(BeanNameGenerator beanNameGenerator) {
		if(beanNameGenerator == null) return;
	...
	public int loadBeanDefinitions(String location, Set<Resource> actualResources) 
		...
		if(resourceLoader instanceof ResourcePatternResolver) {
			...
			try {
				...
				throw new BeanDefinitionStoreException(
						"Could not resolve bean definition resource pattern [" + location + "]", e);
			}
		} else {
	...
	public int loadBeanDefinitions(String... locations) throws BeanDefinitionStoreException {
		Assert.notNull(locations, "Location must not be null");
		int counter = 0;
