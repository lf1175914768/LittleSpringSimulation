...
import com.tutorial.beans.PropertyAccessor;
...
public class PropertiesBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 * @see com.tutorial.util.DefaultPropertiesPersister
	 */
	public void setPropertiesPersister(PropertiesPersister propertiesPersister) {
		if(propertiesPersister == null) return;
	 ...
	 * @see #loadBeanDefinitions(com.tutorial.core.io.Resource, String)
	 */
	 ...
	 * @throws BeanDefinitionStoreException in case of loading or parsing errors
	 */
	public int loadBeanDefinition(EncodedResource encodedResource, String prefix) 
	...
	public int registerBeanDefinitions(ResourceBundle rb, String prefix) throws BeanDefinitionStoreException {
		// Simple create a map and call overloaded method.
	...
	protected void registerBeanDefinition(String beanName, Map<?, ?> map, String prefix, String resourceDescription) 
		...
		for(Entry<?, ?> entry : map.entrySet()) {
			...
			if(key.startsWith(prefix + SEPARATOR)) {
				...
				if(CLASS_KEY.equals(property)) {
					...
					// This isn't a real property, but a reference to another prototypes.
		...
		try {
			...
			throw new CannotLoadBeanClassException(resourceDescription, beanName, className, e);
	 ...
	 */
	private Object readValue(Entry<?, ?> entry) {
