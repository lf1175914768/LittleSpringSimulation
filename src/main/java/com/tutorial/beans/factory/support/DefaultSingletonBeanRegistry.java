...
import com.tutorial.beans.factory.BeanCreationNotAllowedException;
...
import com.tutorial.beans.factory.config.SingletonBeanRegistry;
 ...
 * {@link com.tutorial.beans.factory.config.SingletonBeanRegistry}.
 * Allows for registering singleton instances that should be shared
 * for all callers of the registry, to be obtained via bean name.
 *
 * <p>Also supports registration of
 * {@link com.tutorial.beans.factory.DisposableBean} instances,
 * (which might or might not correspond to registered singletons),
 * to be destroyed on shutdown of the registry. Dependencies between
 * beans can be registered to enforce an appropriate shutdown order.
 *
 * <p>This class mainly serves as base class for
 * {@link com.tutorial.beans.factory.BeanFactory} implementations,
 * factoring out the common management of singleton bean instances. Note that
 * the {@link com.tutorial.beans.factory.config.ConfigurableBeanFactory}
 ...
 * @see com.tutorial.beans.factory.config.ConfigurableBeanFactory
 */
