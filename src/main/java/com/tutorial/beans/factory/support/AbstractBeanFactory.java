...
import com.tutorial.beans.BeanWrapper;
...
import com.tutorial.beans.SimpleTypeConverter;
...
import com.tutorial.beans.factory.BeanIsAbstractException;
import com.tutorial.beans.factory.BeanIsNotAFactoryException;
import com.tutorial.beans.factory.BeanNotOfRequiredTypeException;
import com.tutorial.beans.factory.CannotLoadBeanClassException;
...
import com.tutorial.beans.factory.SmartFactoryBean;
...
import com.tutorial.beans.factory.config.InstantiationAwareBeanPostProcessor;
import com.tutorial.beans.factory.config.Scope;
...
/**
 * Abstract base class for {@link com.tutorial.beans.factory.BeanFactory}
 * implementations, providing the full capabilities of the
 * {@link com.tutorial.beans.factory.config.ConfigurableBeanFactory} SPI.
 * Does <i>not</i> assume a listable bean factory: can therefore also be used
 * as base class for bean factory implementations which obtain bean definitions
 * from some backend resource (where bean definition access is an expensive operation).
 *
 * <p>This class provides a singleton cache (through its base class
 * {@link com.tutorial.beans.factory.support.DefaultSingletonBeanRegistry},
 * singleton/prototype determination, {@link com.tutorial.beans.factory.FactoryBean}
 * handling, aliases, bean definition merging for child bean definitions,
 * and bean destruction ({@link com.tutorial.beans.factory.DisposableBean}
 * interface, custom destroy methods). Furthermore, it can manage a bean factory
 * hierarchy (delegating to the parent in case of an unknown bean), through implementing
 * the {@link com.tutorial.beans.factory.HierarchicalBeanFactory} interface.
 *
...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	private final List<StringValueResolver> embeddedValueResolvers =
			new LinkedList<StringValueResolver>();
	 ...
	 * @see #getBean
	 */
	public AbstractBeanFactory(BeanFactory parent) {
	...
	protected <T> T doGetBean(final String name, Class<T> requiredType, 
	...
	public boolean isSingleton(String name) throws NoSuchBeanDefinitionException {
		...
		if(beanInstance != null) {
			...
			// no singleton instance found -> check bean definitions.
			BeanFactory parentBeanFactory = getParentBeanFactory();
			if(parentBeanFactory != null && !containsBeanDefinition(beanName)) {
			...
			// In case of FactoryBean, return singletons status of created object if not a dereference.
			if(mbd.isSingleton()) {
	...
	public boolean isPrototype(String name) throws NoSuchBeanDefinitionException {
		...
		BeanFactory parentBeanFactory = getParentBeanFactory();
		if(parentBeanFactory != null && !containsBeanDefinition(beanName)) {
			// no definition found in this factory -> delegate to parent.
	...
	public Class<?> getType(String name) throws NoSuchBeanDefinitionException {
		...
		if(beanInstance != null) {
			...
			BeanFactory parentBeanFactory = getParentBeanFactory();
			if(parentBeanFactory != null && !containsBeanDefinition(beanName)) {
				// No beanDefinition found in this factory -> delegate to parent.
				return getParentBeanFactory().getType(originalBeanName(beanName));
			}
	...
	public void setParentBeanFactory(BeanFactory parentBeanFactory) {
		if(this.parentBeanFactory != null && this.parentBeanFactory != parentBeanFactory) {
			throw new IllegalStateException("Already assosiated with parent BeanFactory: " + this.parentBeanFactory);
		}
	 ...
	 * @see com.tutorial.beans.factory.config.DestructionAwareBeanPostProcessor
	 */
	 ...
	 * that will get applied to singleton beans on shutdown.
	 * @see #addBeanPostProcessor
	 * @see com.tutorial.beans.factory.config.InstantiationAwareBeanPostProcessor
	 */
	 ...
	 */
	protected final boolean isPrototypeCurrentlyInCreation(String name) {
		Object curVal = this.prototypesCurrentlyInCreation.get();
		return (curVal != null &&
				(curVal.equals(name) || (curVal instanceof Set && ((Set<?>) curVal).contains(name))));
	}
	...
	public void destroyScopedBean(String beanName) {
		...
		if(scope == null) {
			throw new IllegalStateException(
					"No Scope SPI registered for scope '" + scope + "'");
		}
	...
	protected RootBeanDefinition getMergedBeanDefinition(String beanName, 
			BeanDefinition bd, BeanDefinition containingBd) throws BeanDefinitionStoreException {
	...
	protected void checkMergedBeanDefinition(RootBeanDefinition mbd, String beanName, Object[] args) 
		...
		// Check validity of the args of the args parameter. This can only be used 
		// for the prototypes constructor via a factory method.
	...
	protected Class<?> resolveBeanClass(final RootBeanDefinition mbd, String beanName, 
		...
		try {
			...
			ClassNotFoundException ex = (ClassNotFoundException) e.getException();
			throw new CannotLoadBeanClassException(mbd.getDescription(), beanName, mbd.getBeanClassName(), ex);
	 ...
	 * @see com.tutorial.beans.factory.FactoryBean#getObjectType()
	 * @see #getBean(String)
	 */
	 ...
	 * @param beanName the name of the bean
	 */
	protected void markBeanAsCreated(String name) {
	...
	protected Object getObjectForBeanInstance(Object beanInstance, String name, 
		...
		// If it's a FactoryBean, we use it to create a bean instance , unless the caller 
		// actually wants a reference to the factory.
		if(!(beanInstance instanceof FactoryBean) || BeanFactoryUtils.isFactoryDereference(name)) {
			return beanInstance;
		}
	 ...
	 * @see com.tutorial.beans.factory.config.ConfigurableListableBeanFactory#getBeanDefinition
	 */
