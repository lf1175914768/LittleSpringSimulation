...
public class ClassPathResource extends AbstractFileResolvingResource {
	 ...
	 * @see java.lang.ClassLoader#getResourceAsStream(String)
	 * @see com.tutorial.util.ClassUtils#getDefaultClassLoader()
	 */
	 ...
	 * @see com.tutorial.util.StringUtils#applyRelativePath(String, String)
	 */
	@Override
	 ...
	 * resource refers to.
	 * @see com.tutorial.util.StringUtils#getFilename(String)
	 */
	@Override
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof ClassPathResource) {
			...
			return this.path.equals(otherRes.path) && 
					ObjectUtils.nullSafeEquals(this.classLoader, otherRes.getClassLoader()) && 
					ObjectUtils.nullSafeEquals(this.clazz, otherRes.getClazz());
		}
		return false;
	}
