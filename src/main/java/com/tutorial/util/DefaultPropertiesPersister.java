 ...
 * @see com.tutorial.context.support.ReloadableResourceBundleMessageSource#setPropertiesPersister
 * @see com.tutorial.context.support.ReloadableResourceBundleMessageSource#setDefaultEncoding
 * @see com.tutorial.context.support.ReloadableResourceBundleMessageSource#setFileEncodings
 */
public class DefaultPropertiesPersister implements PropertiesPersister {
	...
	private static final boolean storeToWriteAvailable = 
		...
		while((line = in.readLine()) != null) {
			...
			if(line.length() > 0) {
				...
				if(firstChar != '#' && firstChar != '!') {
					...
					String key = (separatorIndex == -1 ? line : line.substring(0, separatorIndex));
