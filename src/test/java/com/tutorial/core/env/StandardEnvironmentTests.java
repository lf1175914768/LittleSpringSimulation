...
import static com.tutorial.core.env.AbstractEnvironment.ACTIVE_PROFILES_PROPERTY_NAME;
import static com.tutorial.core.env.AbstractEnvironment.DEFAULT_PROFILES_PROPERTY_NAME;
import static com.tutorial.core.env.AbstractEnvironment.RESERVED_DEFAULT_PROFILE_NAME;
...
public class StandardEnvironmentTests {
	...
	public void setActiveProfile_withNullProfileArray() {
	...
	@Test
	public void reservedDefaultProfiles() {
	...
	@Test
	public void acceptsProfile_activeProfileSetProgrammatically() {
